...
# Load packages.
using CSVFiles, DataFrames, Mimi, MimiFAIRv2, StatsBase, Downloads, Query, ProgressMeter
...
function create_fair_monte_carlo(fair_model::Union{Model, MarginalModel}, n_samples::Int;
                                 ...
                                 other_mc_get::Function = ((model, ii) -> nothing),
                                 throwex::Bool=false
                                 )
    ...
    function fair_monte_carlo(  ;co2_em_vals::Union{Nothing, Vector{Vector{T1}}}  = nothing,
        ...
        for i = 1:n_samples
            ...
            try
                ...
                othermc = deepcopy(other_mc_get(fair_instance, i)) # ensure array pointers not saved
